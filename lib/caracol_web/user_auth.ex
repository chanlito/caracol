defmodule CaracolWeb.UserAuth do
  use CaracolWeb, :verified_routes
  ...
  @remember_me_cookie "_caracol_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      CaracolWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      CaracolWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule CaracolWeb.PageLive do
        use CaracolWeb, :live_view

        on_mount {CaracolWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{CaracolWeb.UserAuth, :require_authenticated}] do
