defmodule CaracolWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CaracolWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CaracolWeb.Gettext, "errors", msg, opts)
    end
  end
